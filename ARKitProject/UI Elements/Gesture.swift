...
class TwoFingerGesture: Gesture {
    ...
    func constraintsEnabled(_ enabled: Bool) {
//        for childs in virtualObject.childNodes {
//            for child in childs.childNodes {
//                if child.name == "player" {
//                    print("DebugLog: Child Scale")
//                    child.constraints = enabled ? [SCNBillboardConstraint()] : []
//                    child.scale = virtualObject.scale
//                }
//            }
//        }
    }
